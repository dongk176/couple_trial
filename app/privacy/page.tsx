...
const sections = [
  {
    title: "1. 수집하는 개인정보",
    body: [
      "커플법정은 회원가입과 서비스 제공을 위해 아이디, 비밀번호 해시값, 닉네임, 프로필 이미지, 이름, 성별, 생년월일, 전화번호를 수집합니다.",
  ...
  },
  {
    ...
    body: [
      "커플법정의 사건은 기본적으로 공개 피드에 등록됩니다. 사건 제목, 카테고리, 사건 내용, 원고 주장, 피고 답변, AI 요약, 댓글, 배심 통계는 다른 이용자에게 노출될 수 있습니다.",
  ...
  },
  {
    ...
    body: [
      "커플법정은 이용자의 개인정보를 사전 동의 없이 외부에 판매하거나 임의로 제공하지 않습니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "서비스 내에서 직접 수정할 수 없는 정보의 변경이나 삭제가 필요한 경우 운영팀에 요청할 수 있으며, 커플법정은 본인 확인 후 합리적인 기간 내에 처리합니다.",
  ...
  },
  {
    ...
    body: [
      "커플법정은 만 14세 미만 아동을 대상으로 서비스를 제공하지 않습니다. 만 14세 미만 이용자의 가입 사실이 확인되는 경우 계정 이용이 제한되거나 관련 정보가 삭제될 수 있습니다."
    ]
  },
  {
    title: "10. 문의",
    body: [
      "개인정보 처리와 관련한 문의, 신고, 삭제 요청은 커플법정 운영팀으로 연락해주세요.",
    ...
    <div className="min-h-screen py-6">
      ...
      <section className="pt-6">
        ...
        <p className="mt-3 text-xs font-semibold leading-5 text-[#767986]">
          커플법정은 서비스 제공에 필요한 최소한의 개인정보를 수집하고, 목적에 맞게 안전하게 처리합니다.
        </p>
